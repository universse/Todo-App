...
let SearchTodo = ({clear, input, showCompleted, searchValue}) =>
  <form onSubmit={clear} className='pv3 ba bl-0 bt-0 br-0 b--dotted b--black-30 w-60-l w-70 center'>
    ...
    <div className='center w-100 mt3'>
      <input type='checkbox' onChange={showCompleted} className='dib ml2 mr2' /><label className='f5-ns f6'>Show completed</label>
    </div>
  </form>
